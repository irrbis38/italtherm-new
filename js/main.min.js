...
var Swiper = (function () {
  ...
  // Swiper Class
  const modules = [Keyboard, Navigation, Pagination, Autoplay, EffectFade];
  Swiper.use(modules);
...
"use strict";var initYoutubeVideo=e=>{e.forEach(r=>{var a=r.dataset.video,i=r.parentElement;i.querySelector(".video-play-btn").addEventListener("click",()=>{t=a,(e=document.createElement("iframe")).classList.add("video-iframe"),e.setAttribute("src",t),e.setAttribute("title","YouTube video player"),e.setAttribute("frameborder","0"),e.setAttribute("allowfullscreen",""),e.setAttribute("allow","autoplay; fullscreen; accelerometer; gyroscope; picture-in-picture; encrypted-media");var e,t=e;i.querySelector(".video-preview").remove(),r.append(t)})})},togglePolicy=()=>{var t=document.querySelector(".policy"),e=document.querySelectorAll(".show-policy"),r=document.querySelectorAll(".close-policy");e.forEach(e=>{e.addEventListener("click",()=>{t.classList.add("active"),document.body.classList.add("lock")})}),r.forEach(e=>{e.addEventListener("click",()=>{t.classList.remove("active"),document.body.classList.remove("lock")})})},initInputCheck=e=>{e.forEach(e=>{e.addEventListener("input",()=>{e.classList.remove("error")})})},doFormValidation=e=>{e=e.filter(e=>e.required);0<e.length&&e.forEach(e=>{(!e.dataset.maska||e.value.length===e.dataset.maska.length)&&e.value?e.classList.remove("error"):e.classList.add("error")})},checkErorrs=e=>{return!e.some(e=>e.classList.contains("error"))},initFormValidation=a=>{var e=document.querySelectorAll(".js-form");e.length<0||e.forEach(t=>{var r=Array.from(t.querySelectorAll(".js-input"));0<r.length&&initInputCheck(r),t.addEventListener("submit",e=>{e.preventDefault(),doFormValidation(r),checkErorrs(r)&&(t.reset(),a.classList.add("success"))})})},addMask=()=>{document.querySelectorAll("[data-maska]")&&new Maska.MaskInput("[data-maska]")},initTopSlider=()=>{new Swiper(".top__slider",{slidesPerView:1,spaceBetween:10,navigation:{prevEl:".top__prev",nextEl:".top__next"},breakpoints:{576:{slidesPerView:2,spaceBetween:20},992:{slidesPerView:3,spaceBetween:40}}})},initToggleSteps=()=>{var t,r,a=document.querySelectorAll(".quiz__tab"),e=document.querySelectorAll(".js-quiz-tab");e.length<1||(e.forEach(e=>{var t=Array.from(e.querySelectorAll(".quiz__input")),r=e.querySelector(".quiz__next");t.forEach(e=>{e.addEventListener("input",()=>{t.some(e=>e.checked)?r.disabled=!1:r.disabled=!0})}),r.addEventListener("click",()=>{e.classList.remove("active"),e.nextElementSibling.classList.add("active")})}),t=document.querySelector(".js-quiz-form"),0<(r=Array.from(t.querySelectorAll(".js-input"))).length&&initInputCheck(r),t.addEventListener("submit",e=>{e.preventDefault(),doFormValidation(r),checkErorrs(r)&&(t.reset(),feedback.classList.add("success"),a.forEach(e=>e.classList.contains("quiz__tab--first")?e.classList.add("active"):e.classList.remove("active")))}))};document.addEventListener("DOMContentLoaded",()=>{var e=Array.from(document.querySelectorAll(".video-block")),e=(0<e.length&&initYoutubeVideo(e),togglePolicy(),document.querySelector(".feedback"));e&&initFormValidation(e),addMask(),initTopSlider(),initToggleSteps()});